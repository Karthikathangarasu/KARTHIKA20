    ...
    var methods = (function() {
        ...
        return {
            ...
            show: function() {
                ...
                if ($('#header-outer[data-megamenu-rt="1"]').length > 0 && $(this).hasClass('megamenu') && !$(this).hasClass('width-75') && !$(this).hasClass('width-50') && $('#header-outer').attr('data-transparent-header') == 'true') {
                    $('#header-outer').addClass('no-transition');
                    $('#header-outer').removeClass('transparent');
                }
                o.onBeforeShow.call($ul);
                if (!$ul.hasClass('tracked-pos') && !$($ul).parents('li').hasClass('megamenu') && !$($ul).parents('ul').hasClass('sub-menu') && $ul.offset()) {
